...
def create_application() -> Flask:
    ...
    application.register_blueprint(company_api_v1)
    application.register_blueprint(home_main_feature_promotion_api_v1)
    application.register_blueprint(home_main_feature_reward_api_v1)
    ...
    application.register_blueprint(worker_api_v1)
